...
(function () {
    ...
    /* ============================================================
       ...
       ============================================================ */
    var CONFIG = {
        storageKey: 'patricia_carrilho_cookie_consent', // Chave no localStorage
    ...
    /* ============================================================
       TOGGLE VISUAL DO LINK DE COOKIES NO RODAPÉ (Padrão AG5)
       ============================================================ */
    function updateFooterToggleIcon() {
        ...
        if (state.decided) {
            // Aceitou algum cookie opcional → ativo (bolinha à direita)
            if (state.functional || state.analytics || state.performance || state.advertising) {
                toggle.classList.remove('inactive');
                toggle.classList.add('active');
            } else {
                // Rejeitou tudo (apenas necessários) → inativo (bolinha à esquerda)
                toggle.classList.remove('active');
                toggle.classList.add('inactive');
            }
        } else {
            // Ainda não decidiu → estado padrão (ativo)
            toggle.classList.add('active');
        }
    }
